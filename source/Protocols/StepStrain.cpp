    ...
    -> std::vector<writeableTypes>
{
  ...
  data.emplace_back(_network.getDomain().at(0));
  data.emplace_back(_network.getDomain().at(1));
    ...
    -> std::vector<writeableTypes>
{
  ...
  data.emplace_back(_network.getNodes().position(_bond.src()).at(0));
  data.emplace_back(_network.getNodes().position(_bond.src()).at(1));
  data.emplace_back(_network.getNodes().position(_bond.dst()).at(0));
  data.emplace_back(_network.getNodes().position(_bond.dst()).at(1));
  data.emplace_back(_network.getDomain().at(0));
  data.emplace_back(_network.getDomain().at(1));
  data.emplace_back(getStrain(_network));
